...
destination = str(jsonfile["intersections"][1]["place_id"])

origin = str(jsonfile["intersections"][2]["place_id"])

url = "https://maps.googleapis.com/maps/api/distancematrix/json?" + "departure_time=now" "&destinations=placeid:" + destination + "&origins=place_id:" + origin + "&key=" + api_key
